...
const Burger = () => {
  ...
  const pageCount = Math.ceil(burger.length / itemsPerPage);
  const currentPageData = burger.slice(offset, offset + itemsPerPage);
    ...
    <Layout>
      ...
      <PaginationBox>
        <ReactPaginate
          previousLabel={"<"}
          nextLabel={">"}
          pageCount={Math.ceil(burger.length / itemsPerPage)}
