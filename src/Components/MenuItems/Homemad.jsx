...
import { get_Added_Home_Made_ } from "../../Redux/Get_All_MenuItems/action";
import { delete_Added_Home_Made_ } from "../../Redux/Delete_All_MenuItem/action";
...
const Homemad = () => {
  ...
  const { loading, error, home_made } = useSelector(
  ...
  const handleDelete = (id) => {
    dispatch(delete_Added_Home_Made_(id));
  };
  ...
  const pageCount = Math.ceil(home_made.length / itemsPerPage);
  const currentPageData = home_made.slice(offset, offset + itemsPerPage);
    ...
    <Layout>
      ...
      <PaginationBox>
        <ReactPaginate
          previousLabel={"<"}
          nextLabel={">"}
          pageCount={Math.ceil(home_made.length / itemsPerPage)}
