...
const HouseWings = () => {
  ...
  const pageCount = Math.ceil(hos.length / itemsPerPage);
  const currentPageData = hos.slice(offset, offset + itemsPerPage);
    ...
    <Layout>
      ...
      <PaginationBox>
        <ReactPaginate
          previousLabel={"<"}
          nextLabel={">"}
          pageCount={Math.ceil(hos.length / itemsPerPage)}
