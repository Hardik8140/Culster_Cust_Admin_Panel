...
import { get_Added_Pasta } from "../../Redux/Get_All_MenuItems/action";
...
const Pasta = () => {
  ...
  const handleDelete = (id) => {
    dispatch(delete_Added_Pasta(id));
  };
      ...
      <Box>
        ...
        <Flex my={6} justifyContent={"space-between"}>
          ...
          <Button
            ...
            variant={"simpleWhite"}
          >
            <Link to="/add/pastas" style={linkStyle}>
              Add New Pasta
            </Link>
          </Button>
        </Flex>
