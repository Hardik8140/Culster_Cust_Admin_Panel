...
export const DELETE_EXTRA_ITEM_TOPPINGS_SUCCESS =
  "GET_EXTRA_ITEM_TOPPINGS_SUCCESS";
...
export const POST_TABLE_RESERVATION_SUCCESS = "POST_TABLE_RESERVATION_SUCCESS";
...
export const GET_DETAILS_ORDERS = "GET_DETAILS_ORDERS";
export const ACCEPT_ORDERS = "ACCEPT_ORDERS";

// ===================== GET ALL ORDER & VIEW DETAILS===============================

export const GET_DELIVERY_BOY = "GET_DELIVERY_BOY";
export const ASSIGN_DELIVERY_BOY = "ASSIGN_DELIVERY_BOY";

export const NEW_DELIVERY_BOY_ADDED = "NEW_DELIVERY_BOY_ADDED";
export const DELIVERY_BOY_UPDATED = "DELIVERY_BOY_UPDATED";
